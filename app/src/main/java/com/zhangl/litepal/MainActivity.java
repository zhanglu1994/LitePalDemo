...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initData() {
        ...
        userAdapter.addAll(LitePal.findAll(User.class));
    ...
    private boolean deleteData() {
        ...
        if (!TextUtils.isEmpty(id)) {
            LitePal.delete(User.class, Integer.valueOf(id));
            return true;
        }
    ...
    private boolean selectData() {
        ...
        userAdapter.clear();
        userAdapter.addAll(LitePal.where(sql.toString()).find(User.class));
        return true;
    }
